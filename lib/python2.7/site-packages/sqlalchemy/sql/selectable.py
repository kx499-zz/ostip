...
class CompoundSelect(GenerativeSelect):
    ...
    def __init__(self, keyword, *selects, **kwargs):
        self._auto_correlate = kwargs.pop('_correlate', False)
...
class Select(HasPrefixes, HasSuffixes, GenerativeSelect):
    ...
    def __init__(self,
        ...
        :param _correlate=True:
          ...
          :meth:`.Select._correlate`.

          .. seealso::

            :meth:`.Select._correlate` - full description of correlation.
    ...
    def correlate(self, *fromclauses):
        """return a new :class:`.Select` which will _correlate the given FROM
        ...
        :meth:`.Select._correlate` method provides a fixed list of FROM objects
        that can potentially take place in this process.

        When :meth:`.Select._correlate` is used to apply specific FROM clauses
        ...
        If ``None`` is passed, the :class:`.Select` object will _correlate
        none of its FROM entries, and all will render unconditionally
        in the local FROM clause.

        :param \*fromclauses: a list of one or more :class:`.FromClause`
         constructs, or other compatible constructs (i.e. ORM-mapped
         classes) to become part of the _correlate collection.

         .. versionchanged:: 0.8.0 ORM-mapped classes are accepted by
            :meth:`.Select._correlate`.

        .. versionchanged:: 0.8.0 The :meth:`.Select._correlate` method no
    ...
    def correlate_except(self, *fromclauses):
        ...
        .. versionchanged:: 0.8.2 calling ``correlate_except(None)`` will
           correctly auto-_correlate all FROM clauses.

        :param \*fromclauses: a list of one or more :class:`.FromClause`
         constructs, or other compatible constructs (i.e. ORM-mapped
         classes) to become part of the _correlate-exception collection.
    ...
    def append_correlation(self, fromclause):
        ...
        This is an **in-place** mutation method; the
        :meth:`~.Select._correlate` method is preferred, as it provides
